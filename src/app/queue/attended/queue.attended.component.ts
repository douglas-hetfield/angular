...
@Component({
  selector: 'app-queue.attended',
  templateUrl: './queue.attended.component.html',
  styleUrls: ['./queue.attended.component.scss']
})
export class QueueAttendedComponent implements OnInit {
  ...
  setDestination(destination) {
    ...
    this.queueService.listByStatus(1).subscribe((res: any) => {
      this.queue = res;
